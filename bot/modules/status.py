...
async def mirror_status(_, message):
    ...
    if count == 0:
        ...
        msg = " ㅤ三 鷹 ア サㅤ!\n\nNo Active Tasks!\n\n"
        msg += f"My Works Here <a href='https://t.me/ASA_MIKATA1'> @𝔸𝕤𝕒 𝕄𝕚𝕥𝕒𝕜𝕒</a>ㅤㅤㅤㅤㅤ"
        msg += (
...
def bot_sys_stats():
    ...
    bmsg +="Join Here: <a href='https://t.me/ASA_MIKATA1'>@ASA_MIRROR</a>"
    return bmsg
...
async def stats(_, message, edit_mode=False):
    ...
    bot_stats = f"<b><i><u> ASA Bot StatS </u></i></b>\n\n"\
    ...
    sys_stats = f"<b><i><u>ASA System StatS</u></i></b>\n\n"\
...
async def send_bot_limits(_, query):
    ...
    bot_limit = f"<b><i><u> ASA Bot Limitations</u></i></b>\n" \
